...
import { Users, Briefcase, ChartLineUp, ArrowLeft, ShieldCheck, User, Wrench, Trash } from 'phosphor-react';
                ...
                {activeTab === 'stats' && (
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '16px' }}>
                        <div className="glass-card" style={{ padding: '24px', textAlign: 'center' }}>
                            ...
                            <h3 style={{ margin: 0, fontSize: '2rem' }}>{stats.users}</h3>
                            <p style={{ color: '#666', margin: 0 }}>Usuarios</p>
                        </div>
                        <div className="glass-card" style={{ padding: '24px', textAlign: 'center' }}>
                            <Briefcase size={32} color="#FF9800" style={{ marginBottom: '8px' }} />
                            <h3 style={{ margin: 0, fontSize: '2rem' }}>{stats.active_jobs}</h3>
                            <p style={{ color: '#666', margin: 0 }}>Trabajos Activos</p>
                        </div>
                        <div className="glass-card" style={{ padding: '24px', textAlign: 'center' }}>
                            <ChartLineUp size={32} color="#4CAF50" style={{ marginBottom: '8px' }} />
                            <h3 style={{ margin: 0, fontSize: '2rem' }}>${stats.revenue}</h3>
